...
const unsigned short Custom_Char5x8[] = {
  0,10,31,31,31,14,4,0, // Code for CGRAM memory space 1
  0B01110,0B01010,0B10001,0B10001,0B10001,0B10001,0B11111,0B11111, // Code for CGRAM memory space 2
